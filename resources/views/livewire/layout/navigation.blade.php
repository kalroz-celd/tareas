    ...
    >
        ...
        <nav class="mt-6 space-y-1">
            ...
            <a href="{{ route('passwords.index') }}"
               @class([
                   'flex items-center gap-3 rounded-xl px-3 py-2 text-sm font-semibold',
                   'bg-slate-100 text-slate-900 shadow-sm dark:bg-slate-900 dark:text-slate-100' => request()->routeIs('passwords.*'),
                   'text-slate-700 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-900' => !request()->routeIs('passwords.*'),
               ])
            >
                <span class="h-2 w-2 rounded-full bg-slate-300 dark:bg-slate-700"></span>
                Contraseñas
            ...
            <a href="{{ route('gantt.index') }}"
               @class([
                   'flex items-center gap-3 rounded-xl px-3 py-2 text-sm font-semibold',
                   'bg-slate-100 text-slate-900 shadow-sm dark:bg-slate-900 dark:text-slate-100' => request()->routeIs('gantt.*'),
                   'text-slate-700 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-900' => !request()->routeIs('gantt.*'),
               ])
            >
                <span class="h-2 w-2 rounded-full bg-slate-300 dark:bg-slate-700"></span>
                Gantt
